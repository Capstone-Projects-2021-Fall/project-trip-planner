...
INSERT INTO `User` VALUES (1,'DrChocolates','Karen','Chakwas',NULL),(2,'Batman','Bruce','Wayne',NULL),(3,'Superman','Clark','Kent',NULL),(4,'Spiderman','Peter','Parker',NULL),(5,'Report To the Ship...','Commander','Shepard',NULL),(8,'Also Spiderman','Miles','Morales',NULL),(9,'OptimusPrime','Liara','T\'Soni',NULL),(10,'pinche',NULL,NULL,NULL),(11,'fsdsfgdgsdfg',NULL,NULL,NULL),(12,'what',NULL,NULL,NULL),(13,'real',NULL,NULL,NULL),(14,'reale',NULL,NULL,NULL),(15,'freewilly',NULL,NULL,NULL),(16,'freewilly22',NULL,NULL,NULL),(17,'gdfhdfghdfghdfgh',NULL,NULL,NULL),(18,'tester',NULL,NULL,NULL),(19,'usernametest',NULL,NULL,NULL),(20,'asdfasdf',NULL,NULL,NULL),(21,'test1',NULL,NULL,NULL),(23,'username',NULL,NULL,NULL),(24,'2134123',NULL,NULL,NULL),(25,'meHELLO',NULL,NULL,NULL),(26,'meHELLOdgfhdfgh',NULL,NULL,NULL),(27,'yoyo',NULL,NULL,NULL),(28,'rjames',NULL,NULL,NULL),(29,'sdgsdfg',NULL,NULL,NULL),(30,'sample',NULL,NULL,NULL),(31,'man',NULL,NULL,NULL),(34,'test\'fuzzy',NULL,NULL,NULL),(41,'BobbyHill','Bob','Hill','1999-01-01 00:00:00');
...
BEGIN
	...
	CALL CreateStandalonActivity(title, lat, lon, addr, errorCode, errorMessage);
	...
	BEGIN
		...
		SELECT A.ActivityID INTO @activityID FROM Activity 
		where A.Latitude = lat AND A.Longitude = lon AND A.ActivityName = title LIMIT 1;
            
		Insert Into `ItineraryItem` (ItineraryID, ActivityID, StartTime, EndTime, `Description`)
...
BEGIN
    ...
    THEN
		...
		SELECT A.`ActivityID`, RAW.`ActivityName`, RAW.`Latitude`, RAW.`Longitude`, RAW.`Address`, 
			RAW.`StartTime`, RAW.`EndTine`, RAW.`Description`
		FROM JSON_TABLE(
			...
			`Description` varchar(256) PATH "$.Description")) AS RAW
        ...
        SELECT @itineraryID, U.ActivityID, U.`StartTime`, U.`EndTine`, U.`Description` FROM UI_Data AS U WHERE U.ActivityID IS NOT NULL
        UNION 
        -- the second select is the ones we just added. we can get the ID via a join and all the equal checks. 
        SELECT @itineraryID, A.`ActivityID`, U.`StartTime`, U.`EndTine`, U.`Description` FROM UI_Data AS U 
...
BEGIN
    ...
    INSERT INTO `database`.`Activity` (`ActivityName`, `Latitude`, `Longitude`, `Description`) 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `FindFullItinerariesWithActivitiesWithinACertainDistanceOf` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_ALL_TABLES' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `FindFullItinerariesWithActivitiesWithinACertainDistanceOf`(IN LatCoordinate Decimal(6,4), IN LongCoordinate Decimal(7,4), IN MaxDistanceAwayInMiles DOUBLE)
BEGIN
	SELECT
...
-- Dump completed on 2021-10-31 17:05:57